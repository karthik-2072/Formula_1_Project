...
.json("dbfs:/mnt/dbprojectstorage1/raw/drivers.json")
...
drivers_final_df.write.mode("overwrite").parquet("/mnt/dbprojectstorage1/processed/drivers")
...
display(spark.read.parquet("/mnt/dbprojectstorage1/processed/drivers"))
